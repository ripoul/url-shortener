module.exports = {
  siteMetadata: {
    ...
    description: `Choose your provider among many and transform an unreadable url to a beautiful short url. Choose among the most famous url shortener like bit.ly or other.`,
